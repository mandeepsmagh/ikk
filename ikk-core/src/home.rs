...
impl IkkHome {
    ...
    pub fn config_file(&self) -> PathBuf  { self.root.join("ikk.toml") }
    pub fn lock_file(&self)   -> PathBuf  { self.root.join("ikk.lock") }
    pub fn store_dir(&self)   -> PathBuf  { self.root.join("store") }
    pub fn bin_dir(&self)     -> PathBuf  { self.root.join("bin") }
    pub fn stage_dir(&self)   -> PathBuf  { self.root.join("stage") }
